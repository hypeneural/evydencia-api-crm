...
final class DeleteBlacklistEntryAction
{
    ...
    public function __invoke(Request $request, Response $response): Response
    {
        ...
        try {
            ...
            $this->logger->error('Failed to delete blacklist entry', [
                'trace_id' => $traceId,
                'id' => $id,
                'error' => $exception->getMessage(),
            ]);

            return $this->responder->internalError($response, $traceId, 'Nao foi possivel remover o registro da blacklist.');
        }
