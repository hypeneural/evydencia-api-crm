...
final class ListSchoolPanfletagemLogsAction
{
    ...
    /**
     * @OA\Get(
     *     path="/v1/escolas/{id}/panfletagem/logs",
     *     tags={"Escolas"},
    ...
    public function __invoke(Request $request, Response $response, array $args): Response
    {
        ...
        try {
            $result = $this->service->listPanfletagemLogs($schoolId, $page, $perPage);
        } catch (Throwable) {
            return $this->responder->internalError($response, $traceId, 'Nao foi possivel listar os logs.');
        }
