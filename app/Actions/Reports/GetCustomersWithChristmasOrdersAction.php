...
final class GetCustomersWithChristmasOrdersAction
{
    ...
    public function __invoke(Request $request, Response $response): Response
    {
        ...
        try {
            $result = $this->reportService->fetchCustomersWithChristmasOrders($traceId);
            ...
            $this->logger->error('Unexpected error while fetching customers with christmas orders report', [
                'trace_id' => $traceId,
            ...
            return $this->responder->internalError(
                $response,
                $traceId,
                'Unexpected error while fetching customers with christmas orders report.'
            );
        }
