...
final class SendTextAction
{
    ...
    /**
     * @OA\Post(
     *     path="/v1/whatsapp/text",
     *     tags={"WhatsApp"},
     *     summary="Envia mensagem de texto via Z-API",
     *     @OA\RequestBody(required=true, @OA\JsonContent(ref="#/components/schemas/WhatsAppTextPayload")),
     *     @OA\Response(response=200, description="Mensagem aceita pelo provedor", @OA\JsonContent(ref="#/components/schemas/WhatsAppSendResponse")),
